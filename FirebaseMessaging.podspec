...
device, and it is completely free.
  ...
  s.dependency 'GoogleUtilities/AppDelegateSwizzler', '~> 9.7'
  s.dependency 'GoogleUtilities/Reachability', '~> 9.7'
  s.dependency 'GoogleUtilities/Environment', '~> 9.7'
  s.dependency 'GoogleUtilities/UserDefaults', '~> 9.7'
